...
> **完成判据**：API 语义覆盖（`doc/parity/draw2d/api-coverage.md`）+ 产品层清单（本文）+ Demo 验证（`demo-matrix.md`）三者齐过。
...
**协议层要求**：见 `doc/parity/draw2d/api-coverage.md` 中 M1 相关 family。本文只列产品层清单。
...
**协议层要求**：见 `doc/parity/draw2d/api-coverage.md` 中 M2 相关 family（A1/A2/A3/A5）。本节只列产品层清单。
...
**协议层要求**：见 `doc/parity/draw2d/api-coverage.md` 中 M3 相关 family。本节只列产品层清单。
...
**协议层要求**：见 `doc/parity/draw2d/api-coverage.md` 中 M4 相关 family（A4）。本节只列产品层清单。
...
**协议层要求**：见 `doc/parity/draw2d/api-coverage.md` 中 M5 相关 family（A6/A7/A8）。本节只列产品层清单。
...
**协议层要求**：见 `doc/parity/draw2d/api-coverage.md` 中 M6 相关 family（A9）。本节只列产品层清单。
...
**协议层要求**：见 `doc/parity/draw2d/api-coverage.md` 中 M8 相关 family。本节只列产品层清单。
...
**协议层要求**：见 `doc/parity/draw2d/api-coverage.md` 中 M9 相关 family。本节只列产品层清单。
...
- API 语义覆盖（在 `doc/parity/draw2d/api-coverage.md`）
